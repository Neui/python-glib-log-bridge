...
project = 'Python GLib Log Bridge'
copyright = '2021, Neui'
author = 'Neui'
...
htmlhelp_basename = 'PythonGLibLogBridgedoc'
...
man_pages = [
    (master_doc, 'pythongliblogbridge', 'Python GLib Log Bridge Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PythonGLibLogBridge', 'Python GLib Log Bridge Documentation',
     author, 'PythonGLibLogBridge', 'One line description of project.',
     'Miscellaneous'),
]
